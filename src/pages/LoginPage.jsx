...
const GlowingOrbs = () => {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      <div className="absolute top-20 right-[10%] w-[25rem] h-[25rem] bg-[#9099FC]/20 rounded-full blur-[6rem] animate-pulse"></div>
      <div className="absolute bottom-10 left-[5%] w-[20rem] h-[20rem] bg-[#D87CEE]/20 rounded-full blur-[5rem] animate-pulse"></div>
      <div className="absolute top-1/2 left-[40%] w-[10rem] h-[10rem] bg-[#88E5BE]/20 rounded-full blur-[4rem] animate-pulse"></div>
    </div>
  );
};
      ...
      <div className="relative z-1">
        ...
        <div className="relative z-2 flex flex-col items-center justify-center min-h-screen px-5 py-20">
          <div className="relative w-full max-w-md">
            <div className="absolute -top-8 -left-8 w-64 h-64 bg-gradient-to-br from-[#9099FC]/20 to-transparent rounded-full blur-2xl"></div>
            <div className="absolute -bottom-8 -right-8 w-64 h-64 bg-gradient-to-tr from-[#D87CEE]/20 to-transparent rounded-full blur-2xl"></div>
            
            <div className="relative bg-n-9/70 backdrop-blur-xl rounded-2xl p-8 border border-n-1/10 shadow-xl overflow-hidden">
              <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#9099FC] via-[#D87CEE] to-[#88E5BE]"></div>
              <div className="absolute -left-10 top-10 w-40 h-40 bg-[#9099FC]/10 rounded-full blur-xl"></div>
              <div className="absolute -right-10 bottom-10 w-40 h-40 bg-[#D87CEE]/10 rounded-full blur-xl"></div>
              
              <h1 className="text-4xl font-bold text-center text-white mb-2">Bienvenue</h1>
              <p className="text-n-3 text-center mb-8">Connectez-vous à votre compte</p>
              ...
              <div className="mt-6 text-center">
                <p className="text-n-4">
                  ...
                  <Link to="/register" className="text-[#88E5BE] hover:text-[#9099FC] transition-colors duration-300">
                    S'inscrire
                  </Link>
                </p>
              </div>
