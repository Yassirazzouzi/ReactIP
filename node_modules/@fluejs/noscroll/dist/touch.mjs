import { a as attrAsSelector, N as NoScrollAttrs } from './shared/noscroll.96a94b32.mjs';
...
const onTouchMove = (e) => {
  ...
  const handle = (el, skip = false) => {
    ...
    if (!(skip || isScrollableInput(el) && querySelectorClosestParent(el, attrAsSelector(NoScrollAttrs.SCROLLABLE)) || el.matches(attrAsSelector(NoScrollAttrs.SCROLLABLE)))) {
...
export { hasOverflowHidden, initTouchHandler, isAtScrollBottom, isAtScrollLeft, isAtScrollRight, isAtScrollTop, resetTouchHandler };
